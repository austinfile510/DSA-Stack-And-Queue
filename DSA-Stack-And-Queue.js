class _Node {
  ...
  console.log(is_palindrome('BoooB'))
  ...
  function sortStack(stack) {
    ...
    return sortedStack
    // let lerg = stack.top.data;
    // while (node.next !== null) {
    //   const compareNode = node;
    //   while (node.next) {
    //     //compare current node.data to first loop
    //     if (compareNode.data > node.data) {
  ...
  const numStack = new Stack() // 8, 2, 7, 3, 0, -1, 10
  numStack.push(8)
  numStack.push(2)
  numStack.push(7)
  numStack.push(3)
